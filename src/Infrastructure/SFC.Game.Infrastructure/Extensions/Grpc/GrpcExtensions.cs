...
using SFC.Game.Infrastructure.Interceptors.Grpc.Client;
using SFC.Game.Infrastructure.Interceptors.Grpc.Server;
using SFC.Game.Infrastructure.Services.Identity;
using SFC.Game.Infrastructure.Settings.Grpc;
...
namespace SFC.Game.Infrastructure.Extensions.Grpc;
