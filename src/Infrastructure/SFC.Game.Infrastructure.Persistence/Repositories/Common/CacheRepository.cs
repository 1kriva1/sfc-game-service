...
namespace SFC.Game.Infrastructure.Persistence.Repositories.Common;
    ...
    where TContext : DbContext, IDbContext
{
    ...
    public Task UpdateRangeAsync(params TEntity[] entities) => _repository.UpdateRangeAsync(entities);
